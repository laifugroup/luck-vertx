...
interface LuckActivityRepository: BaseReactorPageableRepository<LuckActivityPO>   {

   fun findByActivityCodeOrderByIdDesc(activityCode:String):Flux<LuckActivityPO>
